...
public class SQLHelper extends SQLiteOpenHelper {
    ...
    private static final String INIT_PARAMETRES="INSERT INTO PARAMETRES( ID, CODEV,NOM, PRENOM,EMAIL, URLSERVEUR,PASSWORD) Values(1,0,'','','@','https://')";
    ...
    public boolean update_PARAMETRES(Integer Codev , String Nom , String Prenom, String Mail , String Urlserveur,String Password) {
        //on cree une variable de type sqLitedatabase pr pouvoir y acceder
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
